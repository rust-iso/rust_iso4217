...
println!("{:?}", rust_iso4217::ALL_CODES);
...
Currency data is generated by `scripts/generate.py` from:

* [SIX Group](https://www.six-group.com/en/products-services/financial-information/data-standards.html) — the ISO 4217 Maintenance Agency. Currency, fund and historic code lists (`list-one.xls`, `list-three.xls`).
* [Country Codes](https://datahub.io/core/country-codes#data) by [DATA HUB](https://datahub.io) — country ↔ currency mapping.
